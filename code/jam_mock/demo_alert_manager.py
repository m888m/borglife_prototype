...
class DemoAlertManager:
    ...
    def __init__(self, alert_file: str = "code/jam_mock/alerts/demo_alerts.jsonl",
    ...
    async def check_alerts(self, metrics: Dict[str, Any] = None,
                          system_status: Dict[str, Any] = None) -> List[Dict[str, Any]]:
        ...
        if metrics and 'average_execution_time' in metrics:
            perf_alert = self._check_performance_alert(metrics['average_execution_time'])
            if perf_alert:
    ...
    def _check_success_rate_alert(self, success_rate: float) -> Optional[Dict[str, Any]]:
    ...
    def _check_error_rate_alert(self, metrics: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    def _check_resource_alerts(self, system_status: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def update_threshold(self, alert_type: str, new_threshold: float,
                        new_severity: str = None) -> bool:
    ...
    def generate_alert_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'most_common_alert': max(alert_counts.items(), key=lambda x: x[1]) if alert_counts else None,
