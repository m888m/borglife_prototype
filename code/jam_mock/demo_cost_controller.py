...
class DemoCostController:
    ...
    def __init__(self, max_budget: Decimal = Decimal('1.0'),
    ...
    async def check_cost_limit(self, proposed_cost: Decimal,
    ...
    async def record_cost(self, cost: Decimal, operation_type: str,
        ...
        try:
            ...
            print(f"✅ Cost recorded: {cost} KSM for {operation_type} "
    ...
    async def refund_cost(self, cost: Decimal, operation_type: str,
                         operation_id: str = None) -> bool:
        ...
        try:
            ...
            print(f"💰 Cost refunded: {cost} KSM for {operation_type} "
                  f"(Total spend: {self.current_spend}/{self.max_budget})")
    ...
    def get_budget_status(self) -> Dict[str, Any]:
        ...
        utilization_percent = (self.current_spend / self.max_budget * 100) if self.max_budget > 0 else 0
    ...
    def _log_budget_transaction(self, amount: Decimal, operation_type: str,
    ...
    def generate_budget_report(self) -> Dict[str, Any]:
        ...
        total_recorded = sum(Decimal(t['amount']) for t in history if t['action'] == 'recorded')
        total_refunded = sum(Decimal(t['amount']) for t in history if t['action'] == 'refunded')
