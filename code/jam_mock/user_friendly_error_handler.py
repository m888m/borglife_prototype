...
class UserFriendlyErrorHandler:
    ...
    def get_user_message(self, error_code: str, technical_details: str = None,
    ...
    def _get_contextual_suggestions(self, error_code: str, context: Dict[str, Any]) -> list:
