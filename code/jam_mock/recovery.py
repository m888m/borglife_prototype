...
class OnChainRecovery:
    ...
    async def retry_storage(
        self, service_index: str, dna_hash: str, max_attempts: int = 5
    ) -> Dict[str, Any]:
        """
        ...
        for attempt in range(max_attempts):
            try:
                result = await self.jam.store_dna_hash(service_index, dna_hash)
    ...
    async def _store_locally(self, service_index: str, dna_hash: str) -> Dict[str, Any]:
